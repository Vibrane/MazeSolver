...
class Node():
    def __init__(self, grid, pos):
        ...
        self.in_path = False  #boolean
        self.visited = False  #boolean
        self.frontier = False #boolean
        self.puddle = False   #boolean
        self.grass = False    #boolean
        self.start = False    #boolean
        self.goal = False     #boolean
    def update(self):
        #The orders are important
        if self.puddle:
            self.color = BLUE # Water is blue
        elif self.start or self.goal:
            self.color = YELLOW  #start and goal are yellow
        elif self.in_path:
            self.color = RED    #if in path = red
            if self.grass:
                self.color = REDGREY  #if in path and grass
        elif self.frontier:  #node in progress
            self.color = GREY
        elif self.visited:   #node already seen
            self.color = DARKGREY
            if self.grass:
